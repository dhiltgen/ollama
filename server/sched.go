...
type Scheduler struct {
	...
	newServerFn  func(gpus discover.GpuInfoList, model, ggufPath string, f *ggml.GGML, adapters []string, projectors []string, opts api.Options, numParallel int) (llm.LlamaServer, error)
...
func (s *Scheduler) load(req *LlmRequest, f *ggml.GGML, gpus discover.GpuInfoList, numParallel int) {
	...
	llama, err := s.newServerFn(gpus, req.model.ManifestPath, req.model.ModelPath, f, req.model.AdapterPaths, req.model.ProjectorPaths, req.opts, numParallel)
	if err != nil {
