...
func useMLXTestThread(t *testing.T) func() {
	t.Helper()
	runtime.LockOSThread()
	// Deliberately do not unlock. The test goroutine exits after cleanup, so
	// MLX thread-local state cannot leak into an unrelated test.
