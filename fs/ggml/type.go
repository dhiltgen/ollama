...
func ParseFileType(s string) (FileType, error) {
	...
	default:
		return FileTypeUnknown, fmt.Errorf("unsupported quantization type %s", s)
	}
}
...
const (
	...
	tensorTypeI8      // not supported by ollama
	tensorTypeI16     // not supported by ollama
	tensorTypeI32     // not supported by ollama
	tensorTypeI64     // not supported by ollama
	TensorTypeF64
